...
def send_IBPC(name = "IBPC_pulse", limit_blue = 50, limit_green =  200, limit_purple = 500, trigger_color = "green", sample_rate = 1e6, acq_time = 60, L = 200, D = 25):
    ...
    add_digital_pulse(link, pins['purple'], 15000, 30000, L, 1)
    add_digital_pulse(link, pins['blue'], 5000, 30000, 30000, 1)
