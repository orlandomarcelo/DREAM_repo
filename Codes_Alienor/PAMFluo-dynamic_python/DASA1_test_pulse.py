...
@ex.automain
def send_IBPC(_run, name, limit_blue, limit_green, limit_purple, limit_red, trigger_color, sample_rate, acq_time, length_SP, length_ML, period_ML, actinic_filter, move_plate, red_level, period, duration):
    ...
    add_digital_pulse(link_arduino, pins['blue'], 1*sec, period*sec, duration*sec, 0)
    ...
    if move_plate:
        ...
        motors = all_links[4]
        python_comm.move_dx(motors, 100)
        TIMING.sleep(2)
        #ipdb.set_trace()
